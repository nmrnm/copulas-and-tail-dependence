...
```{r, initialparameters}
print(paste0("params$n: ",params$n))
print(paste0("params$dim: ",params$dim))
print(paste0("params$rho: ",params$rho))
print(paste0("params$thresh_hi: ",params$thresh_hi))
print(paste0("params$thresh_lo: ",params$thresh_lo))


print(paste0("params$r: ",params$r))
print(paste0("params$numSimulations: ",params$numSimulations))
print(paste0("params$initPopSize: ",params$initPopSize))
print(paste0("params$carryingCapacity: ",params$carryingCapacity))
print(paste0("params$timeSteps: ",params$timeSteps))
```

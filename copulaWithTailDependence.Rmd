...
asymptPopSizeCom <- matrix(data=rep(0,times=dim*timeSteps),nrow=timeSteps)
asymptPopSizeRes <- matrix(data=rep(0,times=dim*timeSteps),nrow=timeSteps)
asymptPopSizeNewRes <- matrix(data=rep(0,times=dim*timeSteps),nrow=timeSteps)
...
asymptNewResTS <- ts(asymptPopSizeCom,names=sprintf("asymptnewRes%s",seq(1:dim)))
...
asymptSumTS <- ts( matrix(data=cbind(totalPopSizeCom,totalPopSizeRes,totalPopSizeNewRes),ncol=3),
